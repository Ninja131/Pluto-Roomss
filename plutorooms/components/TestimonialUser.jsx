  ...
  return (
    <section className="max-container py-24">
      <div className="flex flex-col gap-8 justify-center items-start">
        <h2 className="h2 text-grayMain-700">
        ...
        <div className=" w-full lg:grid lg:grid-cols-12 gap-4">
          ...
          <div className=" px-2 col-span-12 lg:col-span-9 min-h-120 bg-grayMain-800 rounded-3xl flexCenter max-lg:mb-4 relative  max-md:!hidden">
            <QuoteIcon className="absolute text-[#26395A] rotate-180 top-16 left-16" />
            <QuoteIcon className="absolute text-[#26395A] right-16 bottom-16" />
            ...
            <div className="flex flex-col justify-center items-center gap-4 ">
              ...
              <h3 className="h3 text-grayMain-100 text-center max-w-[560px] relative">
                {state.review}
              </h3>
            </div>
          </div>
...
const Card = ({ profile, name, profession, review, onClick, isSelected}) => {
  ...
  return (
    <Accordion
      type="single"
      collapsible
      className={`w-full px-4 py-1 bg-grayMain-800 ${isSelected? 'border-4 border-primary-500':''} rounded-xl`}
        ...
        >
          <div className="flex gap-4">
            ...
            <div>
              ...
              <p className={`body text-grayMain-300 text-grayMain-300`}>{profession}</p>
            </div>
          </div>
